          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <?php
                  $sqlmateri = mysqli_query($conect, "SELECT * FROM tb_layanan");
                  while($materi = mysqli_fetch_assoc($sqlmateri)){
                  ?>
                    
                      <div class="col-lg-6 col-12 ">
                        <div class="card text-start" style="min-width: 200px;">
                          <img src="../../public/img/gambar_layanan/<?= $materi['gambar'] ?>" class="card-img-top" style="min-height: 200px; max-height: 200px;" alt="Gambar Error">
                          <div class="card-body">
                            <h2 class="card-title fs-2 fw-bold"><?= $materi['judul'] ?></h2>
