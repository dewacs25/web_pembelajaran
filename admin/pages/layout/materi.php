          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="isimateri.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Materi</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview ">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../tables/materi.php" class="nav-link ">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Materi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tables/artikel.php" class="nav-link ">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Artikel</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tables/partner.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Patner</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tables/crud_kontak/index.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kontak</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tables/tipsdantrik.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tips & Trik</p>
                  </a>
                </li>
                  ...
                  ?>
                      ...
                      <div class="col-lg-6 col-12 ">
                        <div class="card text-start" style="min-width: 200px;">
                          <img src="../../public/img/gambar_materi/<?= $materi['gambar'] ?>" class="card-img-top" style="min-height: 200px; max-height: 200px;" alt="Gambar Error">
                          <div class="card-body">
                            <h2 class="card-title fs-2 fw-bold"><?= $materi['judul_materi'] ?></h2>
                            <p class="card-text"><?= $materi['isi'] ?></p>
                            <a href="materi/index.php?id=<?= $materi['id_materi'] ?>" class="btn btn-outline-secondary">Lihat Tutorial</a>
                          </div>
                        </div>
                      </div>
