        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="crud_artikel/tambah.php" class="btn btn-primary mb-2 btn-sm w-100">Tambah</a>
                <div class="table-responsive" style="min-height: 400px;">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php
                      $sql = mysqli_query($conect, "SELECT * FROM `tb_artikel` ORDER BY tgl DESC");
                      ...
                      while ($row = mysqli_fetch_array($sql)) { ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="crud_artikel/edit.php?id=<?= $row['id_artikel']; ?>" class="btn btn-warning badge">Edit</a>
                            <a href="crud_artikel/hapus.php?id=<?= $row['id_artikel']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                          </td>
                        </tr>
                      <?php } ?>
