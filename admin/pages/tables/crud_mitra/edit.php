...
$id = $_GET['id'];
$b = mysqli_fetch_array(mysqli_query($conect, "SELECT * FROM tb_mitra WHERE id_mitra='$id'"));


$gambarLama = $_POST['gambarb'];


if (isset($_POST['input'])) {

    
        unlink('../../../public/img/gambar_mitra/' . $gambarLama);
        move_uploaded_file($foto, '../../../public/img/gambar_mitra/' . $newnama);

        $sql = mysqli_query($conect, "UPDATE `tb_mitra` SET `gambar`='$newnama' WHERE id_mitra='$id'");
        if ($sql) {
            echo "<script>alert('ubah berhasil');document.location='../partner.php'</script>";
        } else {
                            ...
                            <div class="card-body">
                                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group mb-3 mt-2">
                                        ...
                                        <label class="input-group-text" for="inputGroupFile02">Logo Mitra Baru</label>
                                    </div>
