              ...
              <div class="card-body">
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="input-group mb-3 mt-2">
                    ...
                    <label class="input-group-text" for="inputGroupFile02">Logo Mitra</label>
                  </div>
...
if (isset($_POST['input'])) {
  ...
  $sql = mysqli_query($conect, "INSERT INTO `tb_mitra`(`id_mitra`,`gambar`) VALUES ('$ir','$newnama')");
  if ($sql) {
    echo "<script>alert('input berhasil');document.location='../partner.php'</script>";
  } else {
