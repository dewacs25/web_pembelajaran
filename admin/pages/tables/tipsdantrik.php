          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="tipsdantrik.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tips & Trik</p>
                  </a>
                </li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="crud_tipsdantrik/tambah.php" class="btn btn-primary mb-2 btn-sm w-100">Tambah</a>
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_array($sql)) { ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="crud_tipsdantrik/edit.php?id=<?= $row['id_tips']; ?>" class="btn btn-warning badge">Edit</a>
                            <a href="crud_tipsdantrik/hapus.php?id=<?= $row['id_tips']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                          </td>
                        </tr>
                      <?php } ?>
