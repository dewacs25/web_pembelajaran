...
<body>
        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse text-lg-start text-center bgg" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-lg-4">
                        <a class="nav-link hover " href="../">Tips dan trik</a>
                    </li>
                    <li class="nav-item me-lg-4">
    ...
    <div class="container-fluid mb-5" style="margin-top: 40px;">
        <div class="row">
            <?php
            $id = $_GET['id'];
            $sqlisi = mysqli_query($conect, "SELECT * FROM tb_artikel WHERE id_artikel='$id'");
            $isi = mysqli_fetch_assoc($sqlisi);
            ?>
            <div class="col-lg-7 col-12 ">
                <div class="card shadow" style=" min-height: 28rem;">
                    <img src="../admin/public/img/gambar_artikel/<?= $isi['gambar'] ?>" class="card-img-top" alt="">
                    <div class="card-body">
                        <h2 class="card-title"><?= $isi['judul'] ?></h2>
            ...
            <div class="col-lg-5 col-12 d-none d-lg-block">
                <div class="card shadow">
                    <div class="card-body ">
                        <h5 class="mb-2 text-bg-secondary rounded p-2">Artikel Lainnya</h5>
                        <?php
                        
                        $sqlartikel = mysqli_query($conect, "SELECT * FROM tb_artikel ORDER BY rand() limit 5");
                        while($artikel = mysqli_fetch_assoc($sqlartikel)){
                        ?>
                        <div class="card text-bg-dark mb-2">
                            <img class="opacity-25" src="../admin/public/img/gambar_artikel/<?= $artikel['gambar'] ?>" class="card-img" alt="...">
